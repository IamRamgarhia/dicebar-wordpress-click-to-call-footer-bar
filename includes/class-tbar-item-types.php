...
class TBar_Item_Types {
	...
	public static function all() {
		 ...
		 * carrying a kind from TBar_Item_Types::VALUE_KINDS.
		 *
		 * @param array $types Registered types keyed by slug.
		 */
		$types = apply_filters( 'tbar_item_types', self::built_in() );
	...
	private static function built_in() {
		return array(
			'call'       => array(
				...
				'value' => array(
					'kind'  => 'phone',
					'label' => __( 'Phone number', 'tapbar-mobile-action-bar' ),
				),
				'extra' => array(),
			),
			'whatsapp'   => array(
				'label' => __( 'WhatsApp', 'tapbar-mobile-action-bar' ),
				'icon'  => 'message',
				'value' => array(
					'kind'  => 'phone',
					'label' => __( 'Number with country code', 'tapbar-mobile-action-bar' ),
				),
				'extra' => array(
					'text' => array(
						'kind'  => 'text',
						'label' => __( 'Message to prefill', 'tapbar-mobile-action-bar' ),
					),
				),
			),
			'sms'        => array(
				'label' => __( 'Text message', 'tapbar-mobile-action-bar' ),
				'icon'  => 'message',
				'value' => array(
					'kind'  => 'phone',
					'label' => __( 'Phone number', 'tapbar-mobile-action-bar' ),
			...
			'email'      => array(
				'label' => __( 'Email', 'tapbar-mobile-action-bar' ),
				'icon'  => 'mail',
				'value' => array(
					'kind'  => 'email',
					'label' => __( 'Email address', 'tapbar-mobile-action-bar' ),
				),
				'extra' => array(
					'subject' => array(
						'kind'  => 'text',
						'label' => __( 'Subject', 'tapbar-mobile-action-bar' ),
					),
				),
			),
			'link'       => array(
				'label' => __( 'Link', 'tapbar-mobile-action-bar' ),
				'icon'  => 'link',
				'value' => array(
					'kind'  => 'url',
					'label' => __( 'Address', 'tapbar-mobile-action-bar' ),
				),
				'extra' => array(
					'new_tab'  => array(
						'kind'  => 'boolean',
						'label' => __( 'Open in a new tab', 'tapbar-mobile-action-bar' ),
					),
					'nofollow' => array(
						'kind'  => 'boolean',
						'label' => __( 'Add nofollow', 'tapbar-mobile-action-bar' ),
					),
				),
			),
			'anchor'     => array(
				'label' => __( 'Scroll to a section', 'tapbar-mobile-action-bar' ),
				'icon'  => 'arrow-down',
				'value' => array(
					'kind'  => 'selector',
					'label' => __( 'Section id, such as #contact', 'tapbar-mobile-action-bar' ),
				),
				'extra' => array(),
			),
			'page'       => array(
				'label' => __( 'Page', 'tapbar-mobile-action-bar' ),
				'icon'  => 'file',
				'value' => array(
					'kind'  => 'post',
					'label' => __( 'Choose a page', 'tapbar-mobile-action-bar' ),
				),
				'extra' => array(),
			),
			'directions' => array(
				'label' => __( 'Directions', 'tapbar-mobile-action-bar' ),
				'icon'  => 'map-pin',
				'value' => array(
					'kind'  => 'text',
					'label' => __( 'Address or map link', 'tapbar-mobile-action-bar' ),
				),
				'extra' => array(),
			),
			'share'      => array(
				'label' => __( 'Share', 'tapbar-mobile-action-bar' ),
				'icon'  => 'share',
				'value' => array(
					'kind'  => 'none',
					'label' => '',
			...
			'top'        => array(
				'label' => __( 'Back to top', 'tapbar-mobile-action-bar' ),
				'icon'  => 'arrow-up',
				'value' => array(
					'kind'  => 'none',
					'label' => '',
			...
			'custom'     => array(
				'label' => __( 'Anything else', 'tapbar-mobile-action-bar' ),
				'icon'  => 'star',
				'value' => array(
					'kind'  => 'url',
					'label' => __( 'Address', 'tapbar-mobile-action-bar' ),
